/* Leaflet.MiniMap (c) By Robert Nordan */
...
(function (L) 
{
	let MiniMap = L.Control.extend({
		...
		addTo: function (map) 
		{
			...
			let center = this.options.centerFixed || this._mainMap.getCenter();
		...
		_decideZoom: function (fromMaintoMini) 
		{
			if (!this._isZoomLevelFixed()) 
			{
				...
				{
					let currentDiff = this._miniMap.getZoom() - this._mainMap.getZoom();
					let proposedZoom = this._miniMap.getZoom() - this.options.zoomLevelOffset;
					let toRet;
		...
		_fireToggleEvents: function () 
		{
			...
			let data = { minimized: this._minimized };
